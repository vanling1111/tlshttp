...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	// The server can (and will, if it's a github.com/vanling1111/tlshttp server) reject
...
// This error type should not escape the github.com/vanling1111/tlshttp package to users.
...
// github.com/vanling1111/tlshttp/httptest package, use [ReadRequest], or manually update the
...
func NewRequestWithContext(ctx context.Context, method, url string, body io.Reader) (*Request, error) {
	...
	if !validMethod(method) {
		return nil, fmt.Errorf("github.com/vanling1111/tlshttp: invalid method %q", method)
	}
	if ctx == nil {
		return nil, errors.New("github.com/vanling1111/tlshttp: nil Context")
	}
