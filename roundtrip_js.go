...
func (t *Transport) RoundTrip(req *Request) (*Response, error) {
	...
	success = js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		case clHeader != "":
			...
			if err != nil {
				errCh <- fmt.Errorf("github.com/vanling1111/tlshttp: ill-formed Content-Length header: %v", err)
				return nil
			}
			if cl < 0 {
				// Content-Length values less than 0 are invalid.
				// See: https://datatracker.ietf.org/doc/html/rfc2616/#section-14.13
				errCh <- fmt.Errorf("github.com/vanling1111/tlshttp: invalid Content-Length header: %q", clHeader)
				return nil
			}
			contentLength = cl
		default:
	...
	failure = js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		errCh <- fmt.Errorf("github.com/vanling1111/tlshttp: fetch() failed: %s", errMsg)
		return nil
	})
...
var errClosed = errors.New("github.com/vanling1111/tlshttp: reader is closed")
