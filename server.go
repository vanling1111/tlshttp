...
var (
	...
	// anything in the github.com/vanling1111/tlshttp package. Callers should not
...
// relevantCaller searches the call stack for the first function outside of github.com/vanling1111/tlshttp.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/vanling1111/tlshttp.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/vanling1111/tlshttp: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.Load() {
		panic("github.com/vanling1111/tlshttp: Hijack called after ServeHTTP finished")
	}
	w.disableWriteContinue()
	if w.wroteHeader {
		w.cw.flush()
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.Load() {
		panic("github.com/vanling1111/tlshttp: CloseNotify called after ServeHTTP finished")
	}
...
// See go.dev/issue/67401.
//
//go:linkname badServeHTTP github.com/vanling1111/tlshttp.serverHandler.ServeHTTP
