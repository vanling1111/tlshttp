...
// use by the github.com/vanling1111/tlshttp package (from Go 1.6 and later).
	...
	for {
		...
		for _, cc := range p.conns[addr] {
			if cc.ReserveNewRequest() {
				// When a connection is presented to us by the github.com/vanling1111/tlshttp package,
...
func (c *http2addConnCall) run(t *HTTP2Transport, key string, tc net.Conn) {
	...
	if err != nil {
		...
		cc.getConnCalled = true // already called by the github.com/vanling1111/tlshttp package
...
// ConfigureServer adds HTTP/2 support to a github.com/vanling1111/tlshttp Server.
//
...
func http2ConfigureServer(s *Server, conf *http2Server) error {
	...
	protoHandler := func(hs *Server, c *tls.Conn, h Handler) {
		...
		// the github.com/vanling1111/tlshttp package passes down its per-connection
		// base context via an exported but unadvertised
		// method on the Handler. This is for internal
		// github.com/vanling1111/tlshttp<=>http2 use only.
...
func (s *http2Server) serveConn(c net.Conn, opts *http2ServeConnOpts, newf func(*http2serverConn)) {
	...
	// The github.com/vanling1111/tlshttp package sets the write deadline from the
...
type http2serverConn struct {
	...
	tlsState         *tls.ConnectionState        // shared by all handlers, like github.com/vanling1111/tlshttp
...
func (sc *http2serverConn) maxHeaderListSize() uint32 {
	...
	// So, take the github.com/vanling1111/tlshttp.Server value and pad it up a bit, assuming 10 headers.
...
// setConnState calls the github.com/vanling1111/tlshttp ConnState hook for this connection, if configured.
// Note that the github.com/vanling1111/tlshttp package does StateNew and StateClosed for us.
...
func http2isClosedConnError(err error) bool {
	...
	// have a way to bundle this into std's github.com/vanling1111/tlshttp somehow.
...
func (sc *http2serverConn) wroteFrame(res http2frameWriteResult) {
	...
	if http2writeEndsStream(wr.write) {
		...
		case http2stateOpen:
			...
			// the github.com/vanling1111/tlshttp package provides no mechanism
...
func (sc *http2serverConn) processHeaders(f *http2MetaHeadersFrame) error {
	...
	// The github.com/vanling1111/tlshttp package sets the read deadline from the
...
func (sc *http2serverConn) upgradeRequest(req *Request) {
	...
	// Disable any read deadline set by the github.com/vanling1111/tlshttp package
...
func (sc *http2serverConn) runHandler(rw *http2responseWriter, req *Request, handler func(ResponseWriter, *Request)) {
	...
	defer func() {
		...
		if didPanic {
			...
			// Same as github.com/vanling1111/tlshttp:
...
func (rws *http2responseWriterState) writeChunk(p []byte) (n int, err error) {
	...
	if !rws.sentHeader {
		...
		if _, ok := rws.snapHeader["Date"]; !ok {
			// TODO(bradfitz): be faster here, like github.com/vanling1111/tlshttp? measure.
...
// checkWriteHeaderCode is a copy of github.com/vanling1111/tlshttp's checkWriteHeaderCode.
...
// ConfigureTransport configures a github.com/vanling1111/tlshttp HTTP/1 Transport to use HTTP/2.
...
// ConfigureTransports configures a github.com/vanling1111/tlshttp HTTP/1 Transport to use HTTP/2.
...
func HTTP2ConfigureTransports(t1 *Transport) (*HTTP2Transport, error) {
	...
	upgradeFn := func(authority string, c interface{}) RoundTripper {
		...
		case net.Conn:
			conn = tlsConn
		default:
			return http2erringRoundTripper{fmt.Errorf("unsupported connection type: %T", c)}
		}
		
		addr := http2authorityAddr("https", authority)
		if used, err := connPool.addConnIfNeeded(addr, t2, conn); err != nil {
			go conn.Close()
			return http2erringRoundTripper{err}
		} else if !used {
			// Turns out we don't need this conn.
...
// needs to be detected by github.com/vanling1111/tlshttp regardless of whether it's its
// bundled version (in h2_bundle.go with a rewritten type name) or
// from a user's x/net/http2. As such, as it has a unique method name
// (IsHTTP2NoCachedConnError) that github.com/vanling1111/tlshttp sniffs for via func
// isNoCachedConnError.
...
// or its equivalent renamed type in github.com/vanling1111/tlshttp2's h2_bundle.go. Both types
...
// errRequestCanceled is a copy of github.com/vanling1111/tlshttp's errRequestCanceled because it's not
...
func (cc *http2ClientConn) roundTrip(req *Request, streamf func(*http2clientStream)) (*Response, error) {
	...
	cancelRequest := func(cs *http2clientStream, err error) error {
		...
		// with github.com/vanling1111/tlshttp checking its readTrackingBody to see if the
...
// a "content-length" request header. This logic is basically a copy of the github.com/vanling1111/tlshttp
...
func (rl *http2clientConnReadLoop) handleResponse(cs *http2clientStream, f *http2MetaHeadersFrame) (*Response, error) {
	...
	if statusCode >= 100 && statusCode <= 199 {
		...
		cs.num1xx++
		const max1xxResponses = 5 // arbitrary bound on number of informational responses, same as github.com/vanling1111/tlshttp
...
func (b http2transportResponseBody) Read(p []byte) (n int, err error) {
	...
	if cs.bytesRemain != -1 {
		if int64(n) > cs.bytesRemain {
			...
			if err == nil {
				err = errors.New("github.com/vanling1111/tlshttp: server replied with more than declared Content-Length; truncated")
				cs.abortStream(err)
			}
			cs.readErr = err
...
func (b http2transportResponseBody) Close() error {
	...
	case <-cs.donec:
	case <-cs.ctx.Done():
		// See golang/go#49366: The github.com/vanling1111/tlshttp package can cancel the
...
// (The field is exported so it can be accessed via reflect from github.com/vanling1111/tlshttp; tested
